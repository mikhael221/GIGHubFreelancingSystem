    ...
    getDefaultIcon(type) {
        switch (type) {
            ...
            case 'contract_termination':
                return '<svg class="w-6 h-6 text-red-600" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M183 146.2h585.15v402.28h73.14V73.06H109.86v877.71h402.16v-73.14H183z" fill="currentColor"></path><path d="M256.14 219.34H695v73.14H256.14zM256.14 365.63h365.71v73.14H256.14zM256.14 511.91h219.43v73.14H256.14zM731.57 585.06c-100.99 0-182.86 81.87-182.86 182.86s81.87 182.86 182.86 182.86 182.86-81.87 182.86-182.86-81.87-182.86-182.86-182.86z m0 292.57c-60.5 0-109.71-49.22-109.71-109.71 0-60.5 49.22-109.71 109.71-109.71 60.5 0 109.71 49.22 109.71 109.71 0 60.49-49.21 109.71-109.71 109.71z" fill="currentColor"></path><path d="M658.16 740.48h146.29v54.86H658.16z" fill="currentColor"></path></g></svg>';
            case 'Contract':
